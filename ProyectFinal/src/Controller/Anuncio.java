...
public class Anuncio {
   ...
   public Anuncio(int id_anuncio, int tiempo_estimado_anuncio, int personas_necesarias_anuncio, String titulo_anuncio, String descripcion_anuncio, String ubicacion_anuncio, Estado estado_anuncio) {
