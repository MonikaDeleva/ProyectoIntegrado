 ...
 * <p>
 * En esta clase podremos cambiar la contraseña del usuario, para eso deberemos
 * introducir la contraseña actual, y dos veces la nueva contraseña.</p>
 *
 * @author 1erDAM
 */
public class FXMLCambiarContrasenyaController implements Initializable {
    ...
    /**
     * <p>
     * Este metodo nos permitirá cambiar nuestra contraseña indicando la
     * contraseña actual y dos veces la nueva contraseña. Se llamará a otro
     * metodo situado en usuarioModel, donde llamará a la base de datos.</p>
     *
     * @param event
     */
    @FXML
    private void cambiarContrasenya(ActionEvent event) {
        ...
        try {
            ...
            contrasenyaActual = usuarioModel.getMD5(contrasenyaActual);
            nuevaContrasenya = usuarioModel.getMD5(nuevaContrasenya);
            confirmarNuevaContrasenya = usuarioModel.getMD5(confirmarNuevaContrasenya);
                ...
                if (contrasenyaActual.equals(Usuario.getUsuario().contrasenya)) {
                    ...
                    if (alert.getResult() == ButtonType.OK) {
                        ...
                        if (usuarioModel.cambiarContrasenya(contrasenyaActual, nuevaContrasenya)) {
                            ...
                            alertaError.setContentText("No se ha podido actualizar la contraseña");
    ...
    /**
     * <p>
     * Este metodo es solo un boton que nos devuelve a la escena de Privacidad Y
     * Seguridad</p>
     *
     * @param event
     */
