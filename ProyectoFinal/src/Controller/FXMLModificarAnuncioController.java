...
public class FXMLModificarAnuncioController implements Initializable {
    ...
    @FXML
    private TextArea descripcionAnuncioTestArea;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        descripcionAnuncioTestArea.setText(Anuncio.getAnuncio().getDescripcion());
    ...
    private void modificarAnuncio(ActionEvent event) {
        ...
        try {
            ...
            String descripcionAnuncio = descripcionAnuncioTestArea.getText();
